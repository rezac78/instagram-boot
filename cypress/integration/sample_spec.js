describe('My first Test', function(){
        ...
        //        })
               it('clients settings',function(){
                        // cy.wait(2000)
                        cy.visit('https://another.live-website.com/wp-admin/admin.php?page=wo_settings')
                        cy.wait(2000)
                        cy.get('input[type="text"]').type("saeid")
                        cy.get('input[type="password"]').type("2121312Ss!")
                        cy.get('input[type="submit"]').first().click()
                        cy.get('input[name="wo_options[enabled]"]').then((e)=>{
                                if(e.find('[name="wo_options[enabled]"]').prevObject[0].checked !== true){
               ...
               it('clients settings',function(){
                        cy.wait(2000)
                        cy.visit('https://another.live-website.com/wp-admin/admin.php?page=wo_add_client')
                        cy.wait(2000)
                        cy.get('input[type="text"]').type("saeid")
                        cy.get('input[type="password"]').type("2121312Ss!")
                        cy.get('input[type="submit"]').first().click()
